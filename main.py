...
def main():
    ...
    baseline_upscaled_bicubic = cv2.resize(baseline_bicubic, (2000, 1200))
    ...
    baseline_upscaled_bilinear = cv2.resize(baseline_bilinear, (2000, 1200))
    ...
    compressed_up = cv2.resize(compressed, (2000,1200),cv2.INTER_CUBIC)
